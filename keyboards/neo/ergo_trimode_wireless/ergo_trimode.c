...
#    ifdef WIRELESS_ENABLWIRELESS_ENABLEE
...
/**/
/*        if (!keymap_is_mac_system() && keymap_config.no_gui) rgb_matrix_set_color(HS_RGB_INDEX_WIN_LOCK, RGB_WHITE);*/
/*    }*/
/**/
/*#ifdef RGBLIGHT_ENABLE*/
